...
### Enter Your Sitename 
$sitename = 'BTCPayprovider';

### Enter your email addresses: @required
$emailTO[] = array( 'email' => 'contact@btcpayprovider.com', 'name' => 'customer service' ); 
...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
	if (isset($_POST["contact-email"]) && $_POST["contact-email"] != '' && isset($_POST["contact-name"]) && $_POST["contact-name"] != '') {
		...
		if ($honeypot == '' && !(empty($emailTO))) {
			...
			$bodymsg .= $_SERVER['HTTP_REFERER'] ? '<br>---<br><br>This email was sent from [BTI, BTCPayprovider]: ' . $_SERVER['HTTP_REFERER'] : '';
